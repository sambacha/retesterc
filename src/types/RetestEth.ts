...
export interface RetestEthInterface extends utils.Interface {
  contractName: "RetestEth";
  functions: {
...
export interface RetestEth extends BaseContract {
  contractName: "RetestEth";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RetestEthInterface;
